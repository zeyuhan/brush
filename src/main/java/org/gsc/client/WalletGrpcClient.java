...
public class WalletGrpcClient {
  ...
  public Account queryAccount(ByteString address) {
    Account request = Account.newBuilder().setAddress(address).build();
  ...
  public Transaction createTransaction(Contract.TransferContract transferContract) {
    Transaction response = walletBlockingStub.createTransaction(transferContract);
    return response;
  }
  ...
  public Optional<VoteStatistics> getWitnessVoteStatistics(){
  ...
  public response_code broadcastTransactionRetry(Transaction signaturedTransaction) {
    GrpcAPI.Return response = walletBlockingStub.broadcastTransaction(signaturedTransaction);
